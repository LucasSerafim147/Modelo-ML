...
MONGO_URI = "mongodb+srv://fariassrafaella:qoQ2wBQg3PTud6tv@odx-pericias.zoribdu.mongodb.net/odx-pericias?retryWrites=true&w=majority&appName=odx-pericias"
...
def gerar_mock():
    ...
    db["vitimas"].insert_many(vitimas_mock)
    db["cases"].insert_many(casos_mock)
